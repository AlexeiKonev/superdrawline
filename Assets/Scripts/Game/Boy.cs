...
public class Boy : MonoBehaviour
{
    ...
    public void SetBoyPath(Queue<Vector3> prevVec, Queue<Vector3> currentVec)
    {
    ...
    {
        if(collision.gameObject.GetComponent<Boy>())
        {
            canMove = false;
            Boy otherBoy = collision.gameObject.GetComponent<Boy>();
            Vector3 otherDir = otherBoy.GetDir();
